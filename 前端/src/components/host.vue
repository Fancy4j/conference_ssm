      ...
      <el-header class="el-header" >
        ...
        <el-dropdown trigger="click">
                        <span class="el-dropdown-link">
                            <i class="el-icon-user-solid el-icon--left"/>{{username}}<i class="el-icon-arrow-down el-icon--right"/>
                        </span>
        ...
        <el-aside width="260px" style="background-color: rgb(238, 241, 246);">
          <el-menu :default-active="this.$route.path"
            ...
            <el-submenu index="1">
              ...
              <el-menu-item-group>
                <el-menu-item index="/caiwu/host/host_conf_list"><i class="el-icon-s-order" />主持会议信息</el-menu-item>
                <el-menu-item index="/caiwu/host/host_submit"><i class="el-icon-coin" />举办新会议</el-menu-item>
              </el-menu-item-group>
            </el-submenu>
          </el-menu>
        </el-aside>
...
export default {
  ...
  created(){
    ...
    this.use = sessionStorage.getItem("username")
  },
  data() {
